    ...
    throws MIDletStateChangeException
  {
    try
    {
      ...
      this.batteryLevelBefore = this.bat.getBatteryLevel();
       this.mem = Spot.getInstance().getDMAMemoryManager();
      ...
      public void run()
      {
        ...
        //{
            if (PowerTest.flag)
            {
                ...
                PowerTest.flag = false;
            }
           // if(index > 20)
                // this.index = 0;
                //PowerTest.this.array[this.index] = ((short)PowerTest.this.pwr.getIdischarge());
            System.out.println(index + ": " + Runtime.getRuntime().freeMemory() + ": " + Runtime.getRuntime().totalMemory()); 
            this.index += 1;
        //}
      }
    }, 0, 50);
...
//    averageCurrent /= (i - this.start);
  ...
  private void memoryTest()
  {
   ...
   // Hashtable temp = null; 
    ...
    if(temp != null)
    {
        System.out.println(" hash table is not null ");
        for(Enumeration e = temp.keys() ; e.hasMoreElements(); )
        {
         System.out.println(temp.get(e));
        }  
    }  
  }
...
//            agent.join();
    ...
    System.out.println("Agent Creation Over");
  }
